...
class QuizBrain {
  ...
  List<Questions> _questionBanks = [
    Questions('You can lead a cow down the stairs but not up stairs.', false),
    Questions(
        'Approxiametely one quarter of human bones are in the feet.', true),
  ...
  void nextQuestion() {
    if (_questionNumber < _questionBanks.length) {
      _questionNumber++;
    }
  }
